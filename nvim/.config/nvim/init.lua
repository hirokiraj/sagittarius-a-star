...
require("lazy").setup({
	...
	{ -- Adds git related signs to the gutter, as well as utilities for managing changes
		...
		opts = {
			...
			current_line_blame_formatter = "<author>, <author_time:%R> <author_time:%Y-%m-%d> 󰇙 <summary>",
		},
	},
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>cd", vim.diagnostic.open_float, "[C]ode [D]iagnostics in float window")
	...
	{ -- You can easily change to a different colorscheme.
		...
		config = function()
			...
			-- As LSP token highliting sucks ballz with catpuccin and for ruby, change prio to preserve highliting from treesitter
			vim.highlight.priorities.semantic_tokens = 4
		end,
	},
